...
/**
 * 支票领用调用九恒星接口的Action（汉宁公司）
 *
 * @author GodWei
 */
public class HngsZplySendJhxAction implements Action {
	...
	public String execute(RequestInfo requestInfo) {
        ...
        //费用类型数据
        rs.execute("select fyxm from uf_hnfygk where id='" + feeType + "'");
        if (rs.next()) {
