 ...
 * @author Alex.Du
 */
public class ZplySendJhxAction implements Action {
    public String execute(RequestInfo requestInfo) {
        ...
        //费用类型数据
        rs.execute("select fyxm from uf_xmlx where id='" + feeType + "'");
        if (rs.next()) {
    ...
    public static void main(String[] args) {
        try {
            JSONObject resultJson = JSONObject.parseObject("{\"code\":\"MPBS-T001\",\"nodeId\":\"client.001\",\"batchNo\":\"04000520191120044\",\"dataLinkId\":\"1197096329818677248\",\"channelId\":\"ERP\",\"clientId\":\"client.002\",\"clientName\":\"网上银行\",\"txDateTime\":\"20191120181907\",\"sendNodeId\":\"client.002\",\"resultCode\":\"E99999\",\"resultMsg\":\"部门信息输入有误\",\"data\":{}}");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
