...
public class ISendMessageServiceServiceLocator extends org.apache.axis.client.Service implements ISendMessageServiceService {
    ...
    //private String ISendMessageServicePort_address = "http://10.4.9.35:8686/DFTC_PI_WS_Proxy/EIP_4_COS_ContractPayInfo";
    private String ISendMessageServicePort_address = new BaseBean().getPropValue("integration_address_config","eip_ht_ws_url");
