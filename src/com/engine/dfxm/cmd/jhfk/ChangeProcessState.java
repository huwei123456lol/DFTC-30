package com.engine.dfxm.cmd.jhfk;
...
*/
public class ChangeProcessState extends AbstractCommonCommand<Map<String, Object>> {
    private Logger log= LoggerFactory.getLogger();

    public ChangeProcessState(Map<String, Object> params, User user) {
        this.user = user;
        this.params = params;
    }
    ...
    public Map<String, Object> execute(CommandContext commandContext) {
        ...
        Map<String, Object> reMap360=doSend3601("360JHJGFK",ids,type,doMsg+"(360)");
        return reMap360;
    }
