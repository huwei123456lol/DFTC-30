package com.engine.dfxm.cmd.fy;
...
*/
public class AcceptGiveUpCollection extends AbstractCommonCommand<Map<String, Object>> {
    private Logger log= LoggerFactory.getLogger();

    public AcceptGiveUpCollection(Map<String, Object> params, User user) {
        this.user = user;
        this.params = params;
    }
    ...
    public Map<String, Object> execute(CommandContext commandContext) {
        ...
        Map<String, Object> reMap360=doSend360("360FQSK",ids,type,doMsg+"(360)");
        return reMap360;
    }
    ...
    private Map<String, Object> doSend360(String operateCode, String ids, String type, String doMsg) {
        ...
        try {
            ...
            String contentType="";
            String apiUrl="";
            //封装后的参数类型，默认1 数组类型， 0表示是对象类型
            String paramType=pmObj.containsKey("paramType")?pmObj.getString("paramType"):"1";
            ...
            if(dataArr.size()>0){
                ...
                if("0".equals(paramType)){
                    //    对象类型
                    request.body(dataArr.getJSONObject(0).toString());
                }else{
