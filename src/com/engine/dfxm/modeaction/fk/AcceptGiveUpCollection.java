package com.engine.dfxm.modeaction.fk;
...
*/
public class AcceptGiveUpCollection extends AbstractModeExpandJavaCodeNew {
		...
		try {
			...
			if(requestInfo!=null){
				...
				if(billid>0&&modeid>0){
					Map<String, Object> reMap360=doSend360("360FQFK",billid+"","","放弃付款(360)");
					log.info("接口返回"+reMap360);
